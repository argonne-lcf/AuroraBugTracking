...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [30](https://github.com/argonne-lcf/AuroraBugTracking/issues/30) | Copy 2D/3D are broken (zeCommandListAppendMemoryCopyRegion) | _No response_ | https://github.com/rpereira-dev/ze-zoo | Romain PEREIRA | Open |  | _No response_ | 2025-05-10 | 2025-05-10 |
