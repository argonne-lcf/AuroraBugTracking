...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [26](https://github.com/argonne-lcf/AuroraBugTracking/issues/26) | IGC internal error with 1099.12 UMD | _No response_ | I was doing the same run as QMCPACK SOW runs in the reframe | Ye Luo | Open | 🚨 | _No response_ | 2025-05-06 | 2025-05-07 |
